export const questionDB = [
    [
        {
            id: 1,
            question: "Chữ đạo trong Phật giáo nghĩa là gì?",
            options: 
            [
        ...
        {
            id: 3,
            question: "Ai khai sáng ra đạo Phật?",
            options:
            [
                "Đức Phật Dược Sư",
                "Đức Phật Di Lặc",
        ...
        {
            id: 4,
            question: "Theo lịch sử đạo Phật có từ khi nào?",
            options:
            [
                "Trước khi Phật ra đời",
                "Từ lúc Phật đản sanh",
                "Từ lúc Thái tử Xuất gia",
        ...
        {
            id: 5,
            question: "Theo phương diện bản thể, đạo Phật có từ lúc nào?",
            options:
            [
                "Đạo Phật có từ vô thỉ",
                "Khi có chúng sinh là có đạo Phật",
                "Đạo Phật có từ vô thỉ, khi có chúng sinh là có đạo Phật",
        ...
        {
            id: 6,
            question: "Phật lịch được tính từ lúc nào?",
            options:
            [
        ...
        {
            id: 7,
            question: "Giáo lý đạo Phật gồm những gì?",
            options:
            [
                "Giới, Định, Tuệ",
                "Văn, Tư, Tu",
                "Gồm 3 tạng: tạng Kinh, tạng Luật, và tạng Luận",
                "Tứ diệu đế, Lục độ, Thập diện nhân duyên",
            ],
            correctOption: 2,
        },
        {
            id: 8,
            question: "Tự giác viên mãn nghĩa là gì?",
            options:
            [
        ...
        {
            id: 9,
            question: "Giác tha viên mãn nghĩa là gì?",
            options:
            [
        ...
        {
            id: 10,
            question: "Như thế nào là Giác ngộ viên mãn?",
            options:
            [
                "Tự mình giác ngộ hoàn toàn do công phu tu tập",
                "Sau khi giác ngộ đem chỉ dạy lại cho người khác giác ngộ",
                "Những bậc tu tập đạt giác ngộ rốt ráo và đem chuyền dạy cho người khác rốt ráo như mình",
                "Mình và người cùng giác ngộ giải thoát",
            ],
            correctOption: 2,
        },
    ],
    [
        {
            ...
            [
                ...
                "Thành Ca Tì La Vệ sẽ giàu có sung túc hơn nữa",
                "Hoàng hậu sẽ tinh quý tử tài đức song toàn",
                "Đáp án A và B",
            ],
            correctOption: 2,
        },
        {
            id: 12,
            question: "Vì sao Đức Phật thị hiện vãn sanh ở giới Ta bà?",
            options:
            [
                "Vì muốn đem lại lợi ích rộng lớn cho đời",
                "Vì muốn độ tất cả chúng sinh",
                "Vì muốn đem hạnh phúc cho chư thiên và loài người",
                "Vì muốn độ tất cả chúng sinh và đem lợi ích rộng lớn cho chư thiên và loài người",
            ],
            correctOption: 3,
        },
        {
            id: 13,
            question: "Đức Phật đãn sanh ở đâu?",
            options:
            [
                "Vườn Lâm Tỳ Ny",
                "Vườn Lộc Uyển",
